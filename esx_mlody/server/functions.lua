...
function isAllowed(a)
  return IsPlayerAceAllowed(a, config.acePermission)
end

function isAllowedToUseMarker(a, b)
  if fullMarkerData[b].jobName == "public_marker" then
    return true
  end
  return ESX.GetPlayerFromId(a).job.grade > fullMarkerData[b].minGrade
end
